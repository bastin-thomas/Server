SandboxVars = {
    ...
    TableSawIsUnGiveWoodworkXp = false,
    TableSawIsEnableDamageHand = false,
    TableSawPlankArrangeNeatly = true,
    -- Min: 5 Max: 100 Default: 6
    TableSawCreatePlankNum = 6,
    -- Min: 50.00 Max: 500.00 Default: 80.00
    TableSawDurable = 80.0,
    -- Min: 100.00 Max: 500.00 Default: 100.00
    TableSawSawBladeDurable = 100.0,
    -- Min: 1.00 Max: 100.00 Default: 100.00
    SawingWoodAcceleration = 100.0,
    TableSawDivider1 = false,
    TableSawIsEnableWeightReduction = false,
    -- Min: 1.00 Max: 100.00 Default: 100.00
    TableSawLogPro = 100.0,
    -- Min: 1.00 Max: 100.00 Default: 100.00
    TableSawLargeBranchPro = 100.0,
    -- Min: 1.00 Max: 100.00 Default: 100.00
    TableSawSaplingPro = 100.0,
    -- Min: 1.00 Max: 100.00 Default: 100.00
    TableSawPlankPro = 100.0,
    -- Min: 1.00 Max: 100.00 Default: 100.00
    TableSawTreeBranch2Pro = 100.0,
    -- Min: 1.00 Max: 100.00 Default: 100.00
    TableSawSplintersPro = 100.0,
    -- Min: 1.00 Max: 100.00 Default: 100.00
    TableSawTwigsPro = 100.0,
    Basement = {
    ...
    CustomizableBackpacks = {
        ...
        CapacityStaticIncrease = 1,
        -- Min: 1 Max: 10000 Default: 1
        CapacityStaticIncreaseWB = 1,
        -- Min: 1 Max: 10000 Default: 1
        CapacityStaticIncreaseB = 1,
        -- Min: 0.01 Max: 200.00 Default: 1.00
    ...
    CustomizableChestRigs = {
        ...
        -- Min: 0.01 Max: 200.00 Default: 1.00
        WeightReductionPercentage = 1.0,
        -- Min: 0.01 Max: 500.00 Default: 1.00
        CapacityPercentage = 1.0,
        -- Min: 0.01 Max: 200.00 Default: 1.00
        WeightPercentage = 1.0,
        -- Min: 0 Max: 100 Default: 0
    ...
    CustomizableVehicles = {
        ...
        CapacityCustomValue = 300,
    },
    CustomizableClothing = {
        SatchelWearable = 2,
        ChestRigWearable = true,
        ShoulderWearable = false,
        Durability = false,
        Degradation = false,
    },
    ...
    B42PackMule = {
        ...
        RifleCase = false,
        WebbingSmall = false,
        WebbingSmallCrafted = false,
        WebbingMedium = false,
        WebbingLarge = false,
        WebbingLargeCrafted = false,
        Vest = false,
        VestAttachment = false,
        VestProtection = false,
        VestRepair = false,
    },
    HereGoesTheSun = {
        EnableGodRays = true,
